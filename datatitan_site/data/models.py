...
class CovidDataRaw(models.Model):
    ...
    icu_patients = models.FloatField(default=0, null=True)
    icu_patients_per_million = models.FloatField(default=0, null=True)
    hosp_patients = models.FloatField(default=0, null=True)
    hosp_patients_per_million = models.FloatField(default=0, null=True)
    weekly_icu_admissions = models.FloatField(default=0, null=True)
    weekly_icu_admissions_per_million = models.FloatField(default=0, null=True)
    weekly_hosp_admissions = models.FloatField(default=0, null=True)
    weekly_hosp_admissions_per_million = models.FloatField(default=0, null=True)
...
class CovidDataClean(models.Model):
    ...
    icu_patients = models.FloatField(default=0)
    icu_patients_per_million = models.FloatField(default=0)
    hosp_patients = models.FloatField(default=0)
    hosp_patients_per_million = models.FloatField(default=0)
    weekly_icu_admissions = models.FloatField(default=0)
    weekly_icu_admissions_per_million = models.FloatField(default=0)
    weekly_hosp_admissions = models.FloatField(default=0)
    weekly_hosp_admissions_per_million = models.FloatField(default=0)
